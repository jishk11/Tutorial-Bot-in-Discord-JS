This folder contains the source code for the [Episode 9 - Embed Pages Video](https://www.youtube.com/watch?v=gWYamvs2LLM).
...
## <ins>**Note:** </ins> ##
  ...
  - Place the `pages.js` file in your "commands" folder.
