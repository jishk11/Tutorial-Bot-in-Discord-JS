This folder contains the source code for the [Episode 8 - Embeds Video](https://www.youtube.com/watch?v=_cCt066twCA).
...
## <ins>**Note:** </ins> ##
  ...
  - Place the `embed.js` file in your "commands" folder.
